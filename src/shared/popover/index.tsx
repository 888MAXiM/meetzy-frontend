...
import type { DynamicPopoverProps, TriggerElementProps } from '../../types/shared'
...
const DynamicPopover: FC<DynamicPopoverProps> = ({
  ...
  useEffect(() => {
    const handleClickOutside = (event: MouseEvent): void => {
      ...
      // If the target is no longer in the document, it was likely removed during a re-render
  ...
  const clonedTrigger = cloneElement(triggerElement, {
    ...
    className: `${triggerElement.props.className || ''} ${className} ${
      triggerType === 'click' ? 'popover-trigger-clickable' : 'popover-trigger-hoverable'
    }`.trim(),
  })
